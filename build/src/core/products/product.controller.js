...
var ProductCtrl = /** @class */ (function () {
    ...
    ProductCtrl.getInstance = function () {
        if (!ProductCtrl.instance)
            ProductCtrl.instance = new ProductCtrl();
        return ProductCtrl.instance;
    };
    ProductCtrl.prototype.getAll = function (req, res) {
    ...
    ProductCtrl.prototype.add = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var product, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductCtrl.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var product, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, product_model_1.default.findByIdAndUpdate(req.params.id, { $set: req.body }, { new: true })];
                    case 1:
                        product = _a.sent();
                        res.status(201).json(product);
                        return [3 /*break*/, 3];
    ...
    ProductCtrl.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = ProductCtrl.getInstance();
